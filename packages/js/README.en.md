...
> [日本語版](./README.md)
>
> 🗂 This is the **JavaScript / TypeScript package** of the [`cao-holidays` multi-language monorepo](https://github.com/aromarious/cao-holidays). For the cross-language overview and roadmap, see the [repo root README](https://github.com/aromarious/cao-holidays#readme).
...
See [SECURITY.md](https://github.com/aromarious/cao-holidays/blob/main/SECURITY.md). Please use [GitHub Private Vulnerability
